...
INSERT INTO startups(name, location, category, employees, raised, valuation, founded, stage, ceo, info)
VALUES('Magic Heap', 'Fort Lauderdale', 'Augmented Reality', 500, 1800000000, 8000000000, 2013, 'D', 'Johnny Malkovich', '¯\_(ツ)_/¯');
...
INSERT INTO startups(name, location, category, employees, raised, valuation, founded, stage, ceo, info)
VALUES('Eärendil', 'Los Angeles', 'Mobile',	2, 50000, 200000, 2009, 'Seed', 'Kent Bergensen', 'Flashlight App');

INSERT INTO startups(name, location, category, employees, raised, valuation, founded, stage, ceo, info)
VALUES('QT', 'Los Angeles', 'Social', 3, 1500000, 4500000, 2018, 'Seed', 'Keiko', 'Who Can Be More Kawaii (づ｡◕‿‿◕｡)づ)');
